...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ asset('mainassets/img/dsad.png') }}" />
</head>
<!--end::Head-->
<!--begin::Body-->
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="#" class="text-center mb-10">
                        <img src="{{ asset('mainassets/img/peng.png') }}" class="max-h-200px" alt="" />
                    </a>
                    <!--end::Aside header-->
                    <!--begin::Aside title-->
                    ...
                    {{-- <div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									...
									<a href="javascript:;" id="kt_login_signup" class="text-primary font-weight-bolder">Buat Akaun</a></span>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								...
								<div class="pb-lg-0 pb-5">
									<button type="button" id="kt_login_signin_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Log Masuk</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
