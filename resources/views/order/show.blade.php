                ...
                <div class="col-xl-12 col-xxl-7">
                    ...
                    <form class="form mt-0 mt-lg-10 fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
                        ...
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="separator separator-dashed my-5"></div>
                            <h6 class="font-weight-bolder mb-3">Receive order:</h6>

                            <div class="text-dark-50 line-height-lg">
                                <a href="{{route('admin.order.edit', ['order' => $order->id])}}" class="btn btn-warning">Receive</a>
                            </div>
                            @else
                            <div class="separator separator-dashed my-5"></div>
                            <h6 class="font-weight-bolder mb-3">Tracking number:</h6>

                            <div class="text-dark-50 line-height-lg">
                                <a class="btn btn-warning">{{$order->tracking_num}}</a>
                            </div>
                            @endif
