                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="name" placeholder="Card Name" value="John Wick">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-lg"
                                                        name="phoneno" placeholder="Card Number" value="xxx-xxx xxxx">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-lg"
                                                        name="postcode" placeholder="Postcode" value="43650">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-lg"
                                                        name="bandar" placeholder="City" value="Bandar baru bangi">
                                                    <span class="form-text text-muted">Please enter your
                                                        City.</span>
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-lg"
                                                        name="negeri" placeholder="State" value="VIC">
                                                    <span class="form-text text-muted">Please enter your
                                                        State.</span>
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
